...
$CXXFLAGS = @(
    ...
    "-DNDEBUG", "-DLARGEBOARDS", "-DPRECOMPUTED_MAGICS", "-DNNUE_EMBEDDING_OFF"
)
$INCLUDES = @("-I.", "-Innue")
$LDFLAGS = @("-static", "-m64")

Write-Host "Compiling Duffish (xiangqi + avx2 + static)..."
...
$objFiles = @(
    "benchmark.o", "bitboard.o", "evaluate.o",
    "main.o", "misc.o", "movegen.o", "movepick.o",
    "position.o", "psqt.o", "search.o", "thread.o",
    "timeman.o", "tt.o", "uci.o", "ucioption.o", "tune.o",
    "piece.o", "variant.o",
    "evaluate_nnue.o", "half_ka_v2.o", "half_ka_v2_variants.o"
)
