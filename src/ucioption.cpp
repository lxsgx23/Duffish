...
void init(OptionsMap& o) {
  ...
  o["SacBonus"]              << Option(50, 0, 100);
  o["DynamicComp"]           << Option(43, 0, 100);
  o["Aggressiveness"]        << Option(130, 0, 200);
  o["AdvisorBreakBonus"]     << Option(17, 0, 100);
  o["BishopBreakBonus"]      << Option(25, 0, 100);
  o["MatScale"]              << Option(25, 0, 100);
  o["SacDetect"]             << Option(30, 0, 100);
  o["DrawMatBias"]           << Option(25, -100, 100);
  o["EvalDecay"]             << Option(15, 0, 100);
