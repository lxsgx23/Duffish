...
void init(OptionsMap& o) {
  ...
  o["DrawValue"]             << Option(-39, -100, 100);
  o["Move Rule"]             << Option(60, 60, 60);
  o["SacBonus"]              << Option(45, 0, 200);
  o["DynamicComp"]           << Option(63, 0, 150);
  o["Aggressiveness"]        << Option(165, 0, 300);
  o["AdvisorBreakBonus"]     << Option(35, 0, 150);
  o["BishopBreakBonus"]      << Option(16, 0, 150);
  o["MatScale"]              << Option(10, 0, 150);
  o["SacDetect"]             << Option(12, 0, 150);
  o["DrawMatBias"]           << Option(25, -100, 100);
  o["EvalDecay"]             << Option(35, 0, 100);
