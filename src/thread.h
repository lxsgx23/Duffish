...
/// Thread class keeps together all the thread-related search state.
...
public:
  ...
  PawnPieceToHistory pawnHistory;
  AttackPieceToHistory attackHistory;
  StaticCorrectionHistory correctionHistory;
